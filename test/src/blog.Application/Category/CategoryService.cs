...
namespace blog.Category
{
    public class CategoryService : ApplicationService, ICateAppService
    {
        ...
        public CategoryService(IRepository<Categories.Category, Guid> cateRepository, IRepository<Posts.Post, Guid> postRepository, IAuthorizationService authorizationService, IHttpContextAccessor httpContextAccessor)
        {
